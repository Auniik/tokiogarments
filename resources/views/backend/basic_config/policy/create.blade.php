...
@section('title','Add Policy Page Information')
@section('PageHead','Add Policies') 
            ...
            <div class="tile-body">
                <form action="{{ route('policy.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{($errors->has('heading')) ? 'is-invalid' : ''}}" type="text" name="heading" value="{{ old('heading') }}" placeholder="Enter heading. example: Our Policy">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" class="form-control {{($errors->has('meta_description')) ? 'is-invalid' : ''}}" rows="5"  placeholder="Enter meta description">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{($errors->has('policy_description')) ? 'is-invalid' : ''}}"  name="policy_description" id="trumbowyg-demo" cols="30" rows="10">{{old('policy_description')}}</textarea>
