        ...
        <div class="tile">
            <div class="tile-body">
                <form action="{{ route('config.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label">Additional Phones</label>
                        <input class="form-control" type="text" name="phone" value="{{ $config->additional_phones }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_discription" class="form-control" rows="5">{{ $config->meta_description }}</textarea>
                    </div>
